...
public class FormFrameIntersection extends JDialog implements ActionListener, DocumentListener, IFormFrameOperation {
	...
	public FormFrameIntersection(mxCell jCell) {

		super((Window) null);
		setModal(true);
		setTitle(intersection.type.getDisplayName());
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getSource() == btnAdd1) {
			...
			intersection.executeOperation(jCell, selectedColumns);
			dispose();
