...
public class FormFrameRightJoin extends JDialog implements ActionListener, IFormFrameOperation {
	...
	public FormFrameRightJoin(mxCell jCell) {
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getSource() == btnPronto) {
			dispose();
			rightJoin.executeOperation(jCell, List.of(comboBoxColumns1.getSelectedItem().toString(),
