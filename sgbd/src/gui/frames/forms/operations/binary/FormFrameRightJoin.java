...
public class FormFrameRightJoin extends JDialog implements ActionListener, IOperator {
	...
	public void executeOperation(mxCell jCell, List<String> data) {
		...
		try {
			...
			Operator operator = new RightNestedLoopJoin(table_1, table_2, (t1, t2) -> {
